...
const Index = () => {
  ...
  const handleContentGenerated = (content: ContentResponse) => {
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="glass-card overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <a href="#generator" className="inline-flex items-center font-medium text-primary hover:underline">
                    Create Content
              ...
              <div className="glass-card overflow-hidden bg-gradient-to-br from-primary/5 to-primary/10">
                <div className="p-6 h-full flex flex-col">
                  ...
                  <a href="#generator" className="inline-flex items-center font-medium text-primary hover:underline mt-4">
          ...
          <div className="container max-w-7xl mx-auto px-6 md:px-10">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <div className="pt-4">
                  <a href="#generator" className="premium-button inline-flex items-center space-x-2">
