      ...
      <div className="container max-w-7xl mx-auto px-6 md:px-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-lg font-semibold">Artful Learning Buddy</h3>
            </div>
            <p className="text-muted-foreground mb-4 max-w-md">
              AI-powered educational content generation platform for Visual Arts, Performing Arts, 
              Coding, Financial Literacy, and Science, helping educators create engaging learning materials.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#generator" className="text-muted-foreground hover:text-primary transition-colors">Content Generator</a>
              </li>
              <li>
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Artful Learning Buddy. All rights reserved.
          </p>
